...
public class AgenciaController implements Serializable {
    ...
    public String prepareView() {
        current = (Agencia) getItems().getRowData();
    ...
    public Agencia getAgencia(java.lang.Integer id) {
        return ejbFacade.find(id);
    }

    @FacesConverter(forClass = Agencia.class)
    public static class AgenciaControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            AgenciaController controller = (AgenciaController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "agenciaController");
            return controller.getAgencia(getKey(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Agencia) {
                Agencia o = (Agencia) object;
                return getStringKey(o.getId());
            } else {
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + Agencia.class.getName());
            }
        }
